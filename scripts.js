...
function marinaraSauce(cookName) {
   ...
   var oneforth = "1/4";
    ...
    console.log("Add " + two + " tspns of oil and 5 garlic cloves, cook until golden, about 2 minutes");
    console.log("Add " + oneforth + " cup water, " + two + " cans of crushed tomatoes, and salt and season with black pepper to taste");
